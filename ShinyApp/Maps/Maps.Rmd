...
map_by_subpop <- map_by_subpop %>% addPolygons(data = loudoun_zips, weight = 1, fillOpacity = 0.1, label = ~loudoun_zip_code_city_names,  highlightOptions = highlightOptions(bringToFront = T), group = "Zip Codes") %>% addLayersControl(overlayGroups = c("Foster Care", "Juvenile Detention", "Zip Codes"))

map_by_pillar <- map_by_pillar %>% addPolygons(data = loudoun_zips, weight = 1, fillOpacity = 0.1, label = ~loudoun_zip_code_city_names,  highlightOptions = highlightOptions(bringToFront = T), group = "Zip Codes") %>% addLayersControl(overlayGroups = c(unique(locations$Pillars), "Zip Codes"))
