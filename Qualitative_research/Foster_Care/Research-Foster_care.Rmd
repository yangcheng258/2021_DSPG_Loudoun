...
### **Youth Empowerment Services** [10] 

*  Youth Employment & Empowerment Services (YES) Team
* mentors help our youth create resumes, get jobs, GED testing, develop realistic career plans, study for tests such as ASVAB, obtain photo identification, take behind-the-wheel and earn driver’s license 
* Youth up to 24 years old 
* Must email to apply

**Address:** 302 Parker Court SE, Leesburg, VA 20175
...
[10] Mobile Hope. (n.d.). https://mobile-hope.org/. 
...
*  empower homeless, precariously-housed and at-risk youth to develop a sense of well-being, unlock their potential  and work toward self-sufficiency
* Shelter, Feed, Clothe, Guide 
* Youth up to 24 years old 
* Must email to apply
...
[3] Mobile Hope. (n.d.). https://mobile-hope.org/. 
...
[website](https://www.second-story.org/homeless-youth/)
...
* Youth 18-24 who are experiencing homelessness or unstably housed
* Youth often come to us who have aged out of foster care, been kicked out of their parent or guardian’s home with insufficient resources, or have run away from an unsafe situation
* Meet U.S. Department of Housing and Urban Development’s (HUD) definition of homelessness, meaning they are living in a homeless shelter, sleeping on the streets or another place not meant for human habitation, or fleeing domestic violence in Fairfax County, and be referred by a community provider
* We have an application and a waiting list
* All services are provided in and around Fairfax County, Virginia
* Must call or email to request an application so no location on website 
* Funded by federal, state, and local grants; community support;in-kind support; other income and program fees  
  
**Address:** Second Story, PO Box 694, Dunn Loring, VA 22027


**LIFT Program (Living Independently for Tomorrow)** 

[website](https://mycri.org/services/youth-services/lift-program)

**LIFT One** 

* provides outreach, transitional living, & support services to help homeless youth who are residents of Fairfax County, VA (ages, 17-21)
* focuses on providing: subsidized apartments that provide stable housing to homeless youth, viable vocational/career skills-building & training, life skills prep, support services (including: shelter, food, clothing, medical assistance, crisis intervention, counseling, referrals & aftercare services)


**LIFT TWO** 

* provide apartment-based Independent Living and Support Services to help foster care youth, ages 17-21, transition from residential care to independent living
* Receive housing, vocational and educational services, life skills training, therapeutic services (counseling, therapy and/or substance abuse education), and the development of a network of support services in the community
* licensed for 25-beds for males and females transitioning from the foster care system to independent living in the community
* 18-24 months 
* Must have a referral made 

**Address: ** CRi Headquarters, 14160 Newbrook Drive, Chantilly VA, 20151


**Bridging Affordability** 
[website](https://www.nvfs.org/assistance/bridging-affordability/)

* collaborative of 14 Fairfax County nonprofit agencies and in partnership with the Department of Housing
* provides case management and supportive services like job training and financial education, depending on client needs, as well as rental assistance for up to 24 months
* Households receiving rental subsidies are required to pay 35% percent of their income for housing and actively work with the case manager to establish and work to achieve self-sufficiency goals
* Referred by Fairfax County, working preference, earning 30% to 50% of area median income (AMI), living or working in Fairfax County
* **not an open referral program** 

**Address:** Oakton – Administrative Headquarters, 10455 White Granite Dr., Suite 100

### Employment 

**Secondary Transition to Employment Program (STEP) **
[website](https://www.fcps.edu/academics/academic-overview/special-education-instruction/career-and-transition-services/step)

* provide students aged 18 to 22 with employment training in real work settings
* receive instruction in applied academics, self-advocacy, and independent living skills
* Chantilly High School: serving students from Chantilly, Centreville, Fairfax, Oakton base schools and part of the Westfield boundary


**Address:** Gatehouse Administration Center, 8115 Gatehouse Road, Falls Church, VA 22042


**Transition to Independence Program (TIP) **
[website](https://www.fcps.edu/academics/academic-overview/special-education-instruction/career-and-transition-services/transition-to-independence)

* This programs helps those students with IEP build employable skills at the local community colleges.

*It helps them have:
* work-based learning, 
* coordinate to postsecondary resources and services,
* provide an opportunity to experience post-secondary education 
* and helps them achieve their goals.


* Must be enrolled at the Davis and Pulley Career Centers and have an IEP
...
[website](https://fairfaxadulths.fcps.edu/about)

* Fairfax County Public Schools offers two ways for adults to complete their high school credential through the Fairfax County Adult High School: High school diploma or high school Equivalency
* Residents of Fairfax County who are 18 years of age and older (no age limit) and who have not earned a GED or high school diploma are eligible for programs at Fairfax County Adult High School

High School Diploma: 

* program for students aged 18-21 (ELL and English Fluent Speakers) and aged 22 + requiring eight credits or less
...
* English Language Learners (ELLs) aged 18—21 do not pay tuitio

High School Equivalency Program: 

* helps prepare *Fairfax County residents aged 18 and over to take the GED test

Need: 
* transcripts (school records that document a student’s attendance, classes taken, and grades earned during each school year)
* immunization record
* SOL results, if applicable
* proof of your Fairfax County residency

**Classes** 

Plum Center - 6815 Edsall Road, Springfield, VA 22151

Fairfax County Adult High School West - 400 Elden Street, Herndon, VA 20170

Justice High School (evening programming only) - 3300 Peace Valley Lane, Falls Church, VA 22044
...
[website](https://www.fairfaxcounty.gov/familyservices/children-youth/permanency-life-skills)

* youth aged 14 to 21 in foster care helps to prepare them for adult responsibilities and choices
* provides SAT prep, application fees, and dorm supplies, household items, moving fees and gift cards for gas, transportation. 
* this is more like Funding 
* Department of Family Services

**Address:** 12011 Government Center Parkway, Pennino Building, Fairfax, VA 22035
...
[website](https://www.fairfaxcounty.gov/neighborhood-community-services/transportation/tops)

Eligibility : Must be a resident of Fairfax County or the City of Fairfax, plus meet one of the following criteria:
...
Program Subsidy : Program participants are eligible for two subsidies per year (one subsidy every six months). Each subsidy will provide \$100 in benefits at a cost to the participant of $20

* Must apply online or send in an application 
...
[website](https://www.fairfaxcounty.gov/neighborhood-community-services/transportation/taxi-voucherprogram)

Eligibility:
* Must be a resident of Fairfax county or the City of Fairfax. 

* Must be a registered user of Metro Access.


Description:
* This program allows qualified users to travel affordable, safely, and independently with the purchase of a discounted taxicab coupon. Cost $10 per $33 coupon book. 8 coupon books per year July 1- June 30
...
* Annual income must be 225% below Federal Poverty Guidelines.


Description:
* This program allows qualified users to travel affordable, safely, and independently with the purchase of a discounted taxicab coupon. Cost $10 per $33 coupon book. 16 coupon books per year July 1- June 30


**Fairfax County Travel Training** 

Eligibility :
* Must be a resident of fairfax county or the City of Fairfax. 

Description:
* This program is designed for independent senior services, but it is open for student travelers who want to learn about the public transit system. 

This course is designed to help citizens:
* plan their trip, 
* read bus and rail schedules, 
* pay bus fares, transfer, 
* reach specific destination, 
* access local transportation resources. 

* Call the Travel Training program at 703-877-5800
