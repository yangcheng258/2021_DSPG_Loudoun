...
#census_api_key("6f1a78212175773dd80d1a03bd303e8d181a6096", install = TRUE)
...
t <- barplot(value$Value, xlab = "Age Groups", ylab = "Totals", main = "Figure1- Age Groups in Foster Care (VA)", col = rainbow(length(value$Value)))
...
## barplot for races 
r <- barplot(race$Value, xlab = "Races", ylab = "Values", main = "Figure4- Races of Foster Care in Loudoun County")
axis(1, at = r, labels=races, cex.axis=0.9, las = 2)
...
pie(data2$value,
    ...
    col = rainbow(length(data2$value)),
...
[5] United States Census Bureau. Loudoun County, Virignia, 2019 https://www.census.gov/quickfacts/loudouncountyvirginia

[6] VA Data, Loudoun County, Virginia, 2020
