...
pie(loudoun_intake_race_FY2020, labels = c("Asian", "Black", "White", "Other/Unlisted"))
```
...
pie(loudoun_intake_ethnicity_FY2020, labels = c("Hispanic", "Non-Hispanic", "Unkown/Missing"))
```
...
pie(loudoun_intake_age_FY2020, labels = ages)
```
...
pie(loudoun_intake_sex_FY2020, labels = sex)
